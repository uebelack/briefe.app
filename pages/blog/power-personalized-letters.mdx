...
<Image src="/blog/power-personalized-letters.jpg" alt="The Power of Personalized Letters: Strengthening Connections in a Digital World" width={800} height={700} />
...
export default ({ children }) => <BlogLayout slug="power-personalized-letters" title="The Power of Personalized Letters: Strengthening Connections in a Digital World">{children}</BlogLayout>;