...
<Image src="/blog/digital-tangible-joy-letters.jpg" alt="From Digital to Tangible: The Joy of Sending and Receiving Physical Letters" width={800} height={700} />
...
export default ({ children }) => <BlogLayout slug="digital-tangible-joy-letters" title="From Digital to Tangible: The Joy of Sending and Receiving Physical Letters">{children}</BlogLayout>;