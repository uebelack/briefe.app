...
<Image src="/blog/art-love-letters.jpg" alt="The Art of Love Letters: Expressing Affection Through the Written Word" width={800} height={700} />
...
export default ({ children }) => <BlogLayout slug="art-love-letters" title="The Art of Love Letters: Expressing Affection Through the Written Word">{children}</BlogLayout>;