...
export const metadata = {
  title:
    "Etikette beim Briefeschreiben: Dos und Don'ts für eine gelungene Korrespondenz | Briefe App",
};
...
<MdxImage
  ...
  alt="Etikette beim Briefeschreiben: Dos und Don'ts für eine gelungene Korrespondenz"
  width={800}
  height={700}
/>
