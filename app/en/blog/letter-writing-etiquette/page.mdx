...
export const metadata = {
  title: "Letter Writing Etiquette: Dos and Don'ts for Polished Correspondence | Letter App",
};

# Letter Writing Etiquette: Dos and Don'ts for Polished Correspondence

<MdxImage src="/blog/letter-writing-etiquette.jpg" alt="Letter Writing Etiquette: Dos and Don'ts for Polished Correspondence" width={800} height={700} />
