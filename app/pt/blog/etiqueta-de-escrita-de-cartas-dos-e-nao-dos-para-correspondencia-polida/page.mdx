...
export const metadata = {
  title:
    "Etiqueta de Escrita de Cartas: Dos e Não Dos para Correspondência Polida | Aplicação de Cartas",
};
...
<MdxImage
  ...
  alt="Etiqueta de Escrita de Cartas: Dos e Não Dos para Correspondência Polida"
  width={800}
  height={700}
/>
