...
export const metadata = {
  title:
    "Étiquette d'Écriture de Lettres : Dos and Don'ts pour une Correspondance Soignée | Application de Lettres",
};
...
<MdxImage
  ...
  alt="Étiquette d'Écriture de Lettres : Dos and Don'ts pour une Correspondance Soignée"
  width={800}
  height={700}
/>
