...
export const metadata = {
  title:
    "Etiqueta de Escritura de Cartas: Dos y No Hacer para una Correspondencia Pulida | Aplicación de Cartas",
};
...
<MdxImage
  ...
  alt="Etiqueta de Escritura de Cartas: Dos y No Hacer para una Correspondencia Pulida"
  width={800}
  height={700}
/>
