...
export default {
  ...
  details: {
    title: 'Details',
    p1: 'Even in an era defined by digital communication and instant connectivity, traditional letters remain an indispensable form of correspondence. Why? Because they represent a timeless and authentic mode of exchange. Whether you are sending personal or business messages, letters convey a depth and significance that is often lost in emails or text messages. They are an expression of care and attention, leaving a lasting impression. Our letter app was designed to blend this timeless tradition with modern convenience, allowing you to create, share, and preserve professional letters in a digital world.',
    p2: 'The Letter App allows you to quickly and effortlessly create and print professionally formatted letters on iPhone, iPad and Mac. Your letters will have an appealing layout that leaves a professional impression. With a simple click, you can print your letters directly from the app. You also have the option to share your letters digitally or export them as PDF files to distribute them on various platforms. The app syncs seamlessly across your devices through iCloud, allowing you to access your letters anytime and anywhere. Thanks to the straightforward search function, you can easily retrieve previously composed letters.',
    p3: 'In the Pro version, you\'ll have access to additional features, such as adding personal signatures directly within the app, effortlessly incorporating contact addresses from your address book, and utilizing a wide range of templates for various occasions. You can customize settings to adapt the format of your letters to your specific needs. The Letter App simplifies your correspondence, enabling you to create, share, and print letters with ease, all while maintaining style and user-friendliness.',
  },
  features: {
    title: 'Features',
    description: 'To give you a comprehensive overview, we have listed all the features in detail, according to their availability in the different app versions. This way, you can easily see which features each version of the app offers.',
    format: {
      title: 'Auto Format',
  ...
  cookie_consent: {
    message: 'This website uses cookies to ensure you get the best experience on our website. To learn more, please refer to our',
    accept: 'Accept',
  },
  lost: {
