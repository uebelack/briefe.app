...
export default {
  ...
  home: {
    teaser: 'Maak en print perfect opgemaakte brieven in no-time.',
  },
  details: {
    title: 'Details',
    p1: 'Zelfs in een tijdperk dat wordt gedefinieerd door digitale communicatie en directe verbondenheid, blijven traditionele brieven een onmisbare vorm van correspondentie. Waarom? Omdat ze een tijdloze en authentieke vorm van uitwisseling vertegenwoordigen. Of u nu persoonlijke of zakelijke berichten verstuurt, brieven brengen een diepgang en betekenis over die vaak verloren gaat in e-mails of tekstberichten. Ze zijn een uiting van zorg en aandacht en laten een blijvende indruk achter. Onze brief-app is ontworpen om deze tijdloze traditie te combineren met moderne gemakken, zodat u professionele brieven kunt maken, delen en bewaren in een digitale wereld.',
    p2: 'De Brieven App stelt je in staat om snel en moeiteloos professioneel opgemaakte brieven te maken en te printen op iPhone, iPad y Mac. Je brieven zullen een aantrekkelijke lay-out hebben die een professionele indruk achterlaat. Met een eenvoudige klik kun je je brieven rechtstreeks vanuit de app printen. Je hebt ook de mogelijkheid om je brieven digitaal te delen of ze als PDF-bestanden te exporteren om ze op verschillende platforms te verspreiden. De app synchroniseert naadloos op al je apparaten via iCloud, waardoor je op elk moment en overal toegang hebt tot je brieven. Dankzij de eenvoudige zoekfunctie kun je eerder opgestelde brieven eenvoudig terughalen.',
    p3: 'In de Pro-versie heb je toegang tot extra functies, zoals het toevoegen van persoonlijke handtekeningen rechtstreeks in de app, moeiteloos contactadressen uit je adresboek opnemen en het gebruik van een breed scala aan sjablonen voor verschillende gelegenheden. Je kunt de instellingen aanpassen om de opmaak van je brieven aan je specifieke behoeften aan te passen. De Brieven App vereenvoudigt je correspondentie, waardoor je gemakkelijk brieven kunt maken, delen en printen, terwijl je stijl en gebruiksvriendelijkheid behoudt.',
  },
  features: {
    title: 'Functies',
    description: 'Om je een uitgebreid overzicht te geven, hebben we alle functies gedetailleerd opgesomd op basis van hun beschikbaarheid in de verschillende app-versies. Op deze manier kun je gemakkelijk zien welke functies elke versie van de app biedt.',
    format: {
    ...
    sync: {
      title: 'Opslag',
      description: 'Je brieven worden gesynchroniseerd over apparaten via iCloud',
    },
    signatures: {
      title: 'Handtekeningen',
      description: 'Voeg persoonlijke handtekeningen rechtstreeks in de app toe',
    },
    contacts: {
      title: 'Contacten',
      description: 'Neem eenvoudig contactadressen op uit je adresboek',
    },
    templates: {
      title: 'Sjablonen',
      description: 'Gebruik een breed scala aan sjablonen voor verschillende gelegenheden',
    },
    layout: {
      title: 'Opmaak',
  ...
  contact: {
    ...
    privacy_1: 'Ik ga akkoord met het',
    privacy_2: 'privacybeleid',
    privacy_link: '/en/privacy',
    privacy_info: 'Je e-mailadres en bericht worden opgeslagen zodat ik erop kan antwoorden. Je gegevens worden niet voor andere doeleinden gebruikt.',
    submit: 'Verzenden',
    email_error: 'Voer een geldig e-mailadres in',
    subject_error: 'Voer een onderwerp in',
    message_error: 'Voer een bericht in',
    captcha_error: 'Los deze captcha op',
    privacy_error: 'Accepteer het privacybeleid',
    success: 'Bedankt voor je bericht! We nemen zo snel mogelijk contact met je op.',
    error: 'Helaas is er een onverwachte fout opgetreden. Probeer het later opnieuw of stuur ons een e-mail naar support@briefe.app.',
    cookie: 'Accepteer cookies onderaan het scherm om een bericht te verzenden of stuur een e-mail naar support@briefe.app.',
  },
  footer: {
  ...
  cookie_consent: {
    message: 'Deze website maakt gebruik van cookies om ervoor te zorgen dat je de beste ervaring op onze website krijgt. Lees meer in ons',
    accept: 'Accepteren',
  },
  lost: {
    title: 'Je bent verdwaald! 404 - Pagina niet gevonden',
